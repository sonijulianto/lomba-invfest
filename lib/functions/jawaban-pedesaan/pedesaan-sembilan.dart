pedesaanSembilan(int pedesaanSembilan) {
  ...
  String d =
      'Tidak terlalu, dik. Bila adik tidak memiliki cukup imun, adik akan dengan mudah terpapar virus penyakit COVID-19.';
  String e =
      'Aman kok, dik. Ketika adik telak divaksinasi adik tidak akan terkenan penyakit COVID-19 lagi selamanya.';
  String pertanyaan =
