...
class PelatihanVaksin extends StatefulWidget {
  const PelatihanVaksin({Key? key}) : super(key: key);

  @override
  State<PelatihanVaksin> createState() => _PelatihanVaksinState();
}

class _PelatihanVaksinState extends State<PelatihanVaksin>
